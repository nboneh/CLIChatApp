...
\fancyhead[C]{CLI Chat App $\bullet$ April 2016 } % Custom header text
...
\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{CLI Chat Application}} % Article title
...
\normalsize \href Source Code: {https://github.com/nboneh/CLIChatApp}{https://github.com/nboneh/CLIChatApp}                    % SouceCode
\vspace{-5mm}
}
\date{}
